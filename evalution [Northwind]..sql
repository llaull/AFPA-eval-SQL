...
/***********************************************************************/
-- 2. Un script comportant deux procédures stockées correspondant aux
-- requêtes 9 et 10. Les procédures stockées doivent prendre en compte les
-- éventuels paramètres
/***********************************************************************/
create proc requeteNeuf
...
exec requeteNeuf 'The Big Cheese'
...
/***********************************************************************/
-- 3. Décrirez par quel moyen et comment vous pourriez implémenter la règle
-- de gestion suivante.
/***********************************************************************/

SELECT distinct(Region) FROM Suppliers WHERE Region IN(SELECT distinct(Region) FROM Customers)
/*Region
---------------
OR
Québec
